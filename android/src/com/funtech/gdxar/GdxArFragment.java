...
import arcore4gdx.BaseARCoreFragment;
import utils.DebugPrint;

/*
 *
 */
public class GdxArFragment extends BaseARCoreFragment implements GdxSessionCallbacks
{
    private final boolean               ENABLE_DEBUG                = true;
    private final String                DEBUG_CLASS_NAME            = GdxArFragment.class.toString();
    private final DebugPrint            m_DebugPrint;
    private GdxArApp                    m_gdxArApp                  = null;

    /*
     *
     */
    public GdxArFragment()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        m_gdxArApp                              = new GdxArApp();
        return initializeForView(m_gdxArApp, config);
    }
